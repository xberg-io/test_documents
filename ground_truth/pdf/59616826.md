...
The functions use either google-play-scraper
or app-store-scraper to
...
retext-keywords is used to extract the keywords
...
options to override the behavior of google-play-scraper
and app-store-scraper.
