...
* pcgrenier/nifi-examples - Apache Nifi Examples by http://www.nifi.rocks
...
* helicopterman22/nifi\_amqp_processors - A set of processors for sending and retrieving messages from an AMQP broker
