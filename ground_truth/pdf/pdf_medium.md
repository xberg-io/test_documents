...
**\_in the exactly the same as_in_ecount(1) and **in is implied if the argument is a const. The following
...
\_\_\_checkReturn, the latter means you ignored the result altogether, for example:
...
\_\_\_declspec form. For example, \_out_ecount(n) maps to:
