...
* The SimpleHTR repository implements a handwritten text recognition system and optionally uses word beam search
...
More information:
* A short overview is given in the poster
* More details can be found in the ICFHR 2018 paper
