...
```go
  ...
  * http.FileServer() -> fasthttp.FSHandler(),
  fasthttp.FS
...
* *Why fasthttp API is incompatible with net/http?*
  ...
  for use:
  * Compare net/http connection hijacking
    to fasthttp connection hijacking.
  * Compare net/http Request.Body reading
    to fasthttp request body reading.
...
* *I detected data race in fasthttp!*
  ...
  * Make sure there are no references to RequestCtx
  or to its' members after returning from RequestHandler.
  * Make sure you call TimeoutError
  before returning from RequestHandler
  if there are references to RequestCtx
