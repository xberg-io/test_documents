...
* The dino dataset comes from the Datasaurus Dozen data.
* HuggingFace's diffusers library.
* lucidrains' DDPM implementation in PyTorch.
* Jonathan Ho's implementation of DDPM.
* InFoCusp's DDPM implementation in tf.
