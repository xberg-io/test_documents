...
* SoX is the _swiss army-knife_ for audio file processing
...
Point your browser to http://127.0.0.1/dictate/ to open a rudimentary dictate.js-interface for testing speech recognition (_for Kaldi only_)
